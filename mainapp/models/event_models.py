...
class Event(models.Model):
    ...
    latitude = models.DecimalField(max_digits=28, decimal_places=25, null=True, default=None)
    longitude = models.DecimalField(max_digits=28, decimal_places=25, null=True, default=None)
